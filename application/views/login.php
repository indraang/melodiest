...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<?php echo base_url('assets_admin/css/bootstrap/bootstrap.min.css')?>">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url('assets_admin/css/AdminLTE.min.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets_admin/css/fonts/font-awesome.min.css')?>">
...
 
    <form action="<?php echo base_url('login2/proses'); ?>" method="post">
...
 
<!-- jQuery 2.2.3 -->
<script src="<?php echo base_url('assets_admin/js/plugins/jQuery/jquery-2.2.3.min.js')?>"></script>
<!-- Bootstrap 3.3.6 -->
